...
class woocommerce_connector(models.Model):
    ...
    debug_text = fields.Char(String='Debug')
    debug_nombreProducto = fields.Char(String='Nombre producto (debug)')
    debug_precio = fields.Char(String='Precio (Debug)')
    ...
    def sync_woocommerce(self, vals):
        ...
        response = requests.get(config_data['con_url'] + config_data['con_endpoint'] + 
                    "products?consumer_key=" + config_data['consumer_key'] +"&consumer_secret=" + 
                        config_data['consumer_secret']+"&exclude=" + ids, verify=False)
        jsonObject = response.json()

        config_data['debug_text'] = jsonObject
        
        config_data['debug_nombreProducto']
        ...
        for data in jsonObject:
            ...
            config_data['debug_nombreProducto'] = data['name']
            config_data['debug_precio'] = data['price']
